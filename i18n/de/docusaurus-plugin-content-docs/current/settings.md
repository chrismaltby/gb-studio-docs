...
<img title="Color" src="/de/img/screenshots/color-palette-v3.png" width="650" className="drop-shadow" />
...
<img title="SGB" src="/de/img/screenshots/sgb-mode.png" width="650" className="drop-shadow" />
...
<img title="Default Player Sprites" src="/de/img/screenshots/default-sprites.png" width="650" className="drop-shadow" />
...
<img title="UI Elements" src="/de/img/screenshots/ui-elements-v3.png" width="650" className="drop-shadow" />
...
<img src="/de/img/screenshots/gbs-var.png" width="256" className="drop-shadow" />
...
<img title="Music Driver" src="/de/img/screenshots/music-driver.png" width="650" className="drop-shadow" />
...
<img title="Engine Settings" src="/de/img/screenshots/engine-settings.png" width="650" className="drop-shadow" />
...
<img title="Controls" src="/de/img/screenshots/controls-v3.png" width="650" className="drop-shadow" />
