...
<ScriptEventPreview title={"Link: Übertragen"} fields={[{"key":"sendVariable","label":"Variable senden","description":"The variable to send to the other player.","type":"variable","defaultValue":"LAST_VARIABLE"},{"key":"receiveVariable","label":"Variable empfangen","description":"The variable used to store the value received from the other player.","type":"variable","defaultValue":"LAST_VARIABLE"},{"key":"size","label":"Paketgröße","description":"The number of consecutive variables to transfer.  \nFor example, setting `Send Variable` to `$Variable 1` with a packet size of `5` transfers `$Variable 1` through to `$Variable 5` in a single transfer. Larger packet sizes take longer to transfer.","type":"number","defaultValue":1}]} />
