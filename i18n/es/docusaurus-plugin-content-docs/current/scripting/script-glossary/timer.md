...
### Limitar Tasa
Limita cuán frecuentemente se puede ejecutar este script. Si el script se dispara de nuevo antes de que el límite de tiempo se haya cumplido, el script se saltará.
<ScriptEventPreview title={"Limitar Tasa"} fields={[{"key":"variable","label":"Variable de tiempo de llamada siguiente","description":"La variable que almacenará el siguiente tiempo, en frames, que este script puede ser llamado.","type":"variable","defaultValue":"LAST_VARIABLE"},{"key":"time","label":"Intervalo de tiempo","description":"El tiempo mínimo de espera entre llamadas sucesivas de este script.","type":"constvalue","min":0,"max":60,"step":0.1,"unitsField":"units","unitsDefault":"time","unitsAllowed":["time","frames"],"defaultValue":{"type":"number","value":0.5},"conditions":[{"key":"units","ne":"frames"}]},{"key":"frames","label":"Intervalo de tiempo","description":"El tiempo mínimo de espera entre llamadas sucesivas de este script.","type":"constvalue","min":0,"max":3600,"unitsField":"units","unitsDefault":"time","unitsAllowed":["time","frames"],"defaultValue":{"type":"number","value":1},"conditions":[{"key":"units","eq":"frames"}]},{"key":"true","label":"Limitado por tasa","description":"El script que será limitado por tasa","type":"events"}]} />

- **Variable de tiempo de llamada siguiente**: La variable que almacenará el siguiente tiempo, en frames, que este script puede ser llamado.  
- **Intervalo de tiempo**: El tiempo mínimo de espera entre llamadas sucesivas de este script.  
- **Limitado por tasa**: El script que será limitado por tasa  

### Esperar
Pausar el script por un período de tiempo.
<ScriptEventPreview title={"Esperar"} fields={[{"key":"time","label":"Duración","description":"El período de tiempo para pausar el script en segundos o fotogramas.","type":"value","min":0,"max":60,"step":0.1,"unitsField":"units","unitsDefault":"time","unitsAllowed":["time","frames"],"defaultValue":{"type":"number","value":0.5},"conditions":[{"key":"units","ne":"frames"}]},{"key":"frames","label":"Duración","description":"El período de tiempo para pausar el script en segundos o fotogramas.","type":"value","min":0,"max":3600,"width":"50%","unitsField":"units","unitsDefault":"time","unitsAllowed":["time","frames"],"defaultValue":{"type":"number","value":1},"conditions":[{"key":"units","eq":"frames"}]}]} />
