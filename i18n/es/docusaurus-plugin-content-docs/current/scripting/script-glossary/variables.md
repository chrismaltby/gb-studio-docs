...
<ScriptEventPreview title={"Variable: Cambiar a 'Falso'"} fields={[{"key":"variable","label":"Variable","description":"The variable to use.","type":"variable","defaultValue":"LAST_VARIABLE"}]} />

- **Variable**: The variable to use.  

## Variable: Cambiar a 'Verdadero'
Set the value of the specified variable to true.
<ScriptEventPreview title={"Variable: Cambiar a 'Verdadero'"} fields={[{"key":"variable","label":"Variable","description":"The variable to use.","type":"variable","defaultValue":"LAST_VARIABLE"}]} />

- **Variable**: The variable to use.  

## Variable: Cambiar a valor
Set the specified variable to a defined value.
<ScriptEventPreview title={"Variable: Cambiar a valor"} fields={[{"key":"variable","label":"Variable","description":"The variable to use.","type":"variable","defaultValue":"LAST_VARIABLE"},{"key":"value","label":"Valor","description":"The value to set the selected variable to.","type":"union","types":["number","variable","property"],"defaultType":"number","min":-32768,"max":32767,"defaultValue":{"number":0,"variable":"LAST_VARIABLE","property":"$self$:xpos"}}]} />
