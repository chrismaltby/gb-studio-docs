...
<img title="Color" src="/es/img/screenshots/color-palette-v3.png" width="650" className="drop-shadow" />
...
<img title="SGB" src="/es/img/screenshots/sgb-mode.png" width="650" className="drop-shadow" />
...
<img title="Default Player Sprites" src="/es/img/screenshots/default-sprites.png" width="650" className="drop-shadow" />
...
<img title="UI Elements" src="/es/img/screenshots/ui-elements-v3.png" width="650" className="drop-shadow" />
...
<img src="/es/img/screenshots/gbs-var.png" width="256" className="drop-shadow" />
...
<img title="Music Driver" src="/es/img/screenshots/music-driver.png" width="650" className="drop-shadow" />
...
<img title="Engine Settings" src="/es/img/screenshots/engine-settings.png" width="650" className="drop-shadow" />
...
<img title="Controls" src="/es/img/screenshots/controls-v3.png" width="650" className="drop-shadow" />
